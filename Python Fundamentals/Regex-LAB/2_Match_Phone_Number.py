...
· Ensure that there is a space before the '+' sign, or it is positioned at the beginning of the strin"""
...
valid_nums = [obj.group() for obj in re.finditer(pattern,text)]
