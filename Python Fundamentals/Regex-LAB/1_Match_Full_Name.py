...
To help you out, we have outlined several steps: 1. Use the online regex tester like https://pythex.org/
...
valid_names = [obj.group() for obj in re.finditer(pattern, text)]
